...
hhttps://discord.new/eHar9McEguWT`).catch(error => message.channel.send(new Discord.MessageEmbed().setDescription("Mesajı gönderemedim. Muhtemelen DM'n kapalı."))); /// PinkCode - Buradaki GsYDbB9VpnWE yerine şablonunuzu yapıştırın
};
exports.conf = {
  enabled: true,
  guildOnly: true,
